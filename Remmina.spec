...
Source0  : https://github.com/FreeRDP/Remmina/archive/v1.4.25/Remmina-1.4.25.tar.gz
...
%prep
%setup -q -n Remmina-1.4.25
cd %{_builddir}/Remmina-1.4.25
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1647040997
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/Remmina-1.4.25/COPYING %{buildroot}/usr/share/package-licenses/Remmina/8176005338c69cb3cebe08b9a4e6c884251ef6ba
cp %{_builddir}/Remmina-1.4.25/LICENSE %{buildroot}/usr/share/package-licenses/Remmina/62df4d47ea6d73566d5e8de65d8e126fd096fc4f
cp %{_builddir}/Remmina-1.4.25/LICENSE.OpenSSL %{buildroot}/usr/share/package-licenses/Remmina/e3ca00760c7f1c1d8e8b306eb7e41f3bf4d7f10a
pushd clr-build
%make_install
popd
%find_lang remmina
