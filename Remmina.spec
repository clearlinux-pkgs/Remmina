...
Version  : 1.2.30.1
Release  : 7
URL      : https://github.com/FreeRDP/Remmina/archive/v1.2.30.1.tar.gz
Source0  : https://github.com/FreeRDP/Remmina/archive/v1.2.30.1.tar.gz
...
Requires: Remmina-license
Requires: Remmina-locales
Requires: Remmina-man
...
export LANG=C
export SOURCE_DATE_EPOCH=1536776850
mkdir -p clr-build
pushd clr-build
...
export SOURCE_DATE_EPOCH=1536776850
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/doc/Remmina
cp COPYING %{buildroot}/usr/share/doc/Remmina/COPYING
cp LICENSE %{buildroot}/usr/share/doc/Remmina/LICENSE
cp LICENSE.OpenSSL %{buildroot}/usr/share/doc/Remmina/LICENSE.OpenSSL
pushd clr-build
%make_install
popd
%find_lang remmina
...
%files license
%defattr(-,root,root,-)
/usr/share/doc/Remmina/COPYING
/usr/share/doc/Remmina/LICENSE
/usr/share/doc/Remmina/LICENSE.OpenSSL
