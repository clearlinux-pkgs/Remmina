...
Version  : 1.4.36
Release  : 61
URL      : https://github.com/FreeRDP/Remmina/archive/v1.4.36/Remmina-1.4.36.tar.gz
Source0  : https://github.com/FreeRDP/Remmina/archive/v1.4.36/Remmina-1.4.36.tar.gz
...
%prep
%setup -q -n Remmina-1.4.36
cd %{_builddir}/Remmina-1.4.36
pushd ..
cp -a Remmina-1.4.36 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1727897149
mkdir -p clr-build
pushd clr-build
