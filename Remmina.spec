...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707321816
mkdir -p clr-build
pushd clr-build
...
/VA/usr/lib64/remmina/plugins/remmina-plugin-exec.so
/VA/usr/lib64/remmina/plugins/remmina-plugin-python_wrapper.so
/VA/usr/lib64/remmina/plugins/remmina-plugin-secret.so
/VA/usr/lib64/remmina/plugins/remmina-plugin-spice.so
/VA/usr/lib64/remmina/plugins/remmina-plugin-vnc.so
/VA/usr/lib64/remmina/plugins/remmina-plugin-www.so
