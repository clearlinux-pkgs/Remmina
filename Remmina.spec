...
Version  : 1.3.3
Release  : 16
URL      : https://github.com/FreeRDP/Remmina/archive/v1.3.3.tar.gz
Source0  : https://github.com/FreeRDP/Remmina/archive/v1.3.3.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1551809527
mkdir -p clr-build
pushd clr-build
