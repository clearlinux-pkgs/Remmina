...
Version  : 1.2.30
Release  : 6
URL      : https://github.com/FreeRDP/Remmina/archive/v1.2.30.tar.gz
Source0  : https://github.com/FreeRDP/Remmina/archive/v1.2.30.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1527264150
mkdir clr-build
pushd clr-build
