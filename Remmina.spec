...
Version  : 1.4.37
Release  : 63
URL      : https://github.com/FreeRDP/Remmina/archive/v1.4.37/Remmina-1.4.37.tar.gz
Source0  : https://github.com/FreeRDP/Remmina/archive/v1.4.37/Remmina-1.4.37.tar.gz
...
%prep
%setup -q -n Remmina-1.4.37
cd %{_builddir}/Remmina-1.4.37
pushd ..
cp -a Remmina-1.4.37 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735106988
mkdir -p clr-build
pushd clr-build
