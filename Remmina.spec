...
Version  : 1.4.28
Release  : 40
URL      : https://github.com/FreeRDP/Remmina/archive/v1.4.28/Remmina-1.4.28.tar.gz
Source0  : https://github.com/FreeRDP/Remmina/archive/v1.4.28/Remmina-1.4.28.tar.gz
...
%prep
%setup -q -n Remmina-1.4.28
cd %{_builddir}/Remmina-1.4.28
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1670536795
mkdir -p clr-build
pushd clr-build
