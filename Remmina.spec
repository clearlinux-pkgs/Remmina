...
Source0  : https://github.com/FreeRDP/Remmina/archive/v1.3.2.tar.gz
Summary  : remote desktop client written in GTK+
...
export LANG=C
export SOURCE_DATE_EPOCH=1549124065
mkdir -p clr-build
pushd clr-build
