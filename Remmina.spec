...
Version  : 1.2.32
Release  : 8
URL      : https://github.com/FreeRDP/Remmina/archive/v1.2.32.tar.gz
Source0  : https://github.com/FreeRDP/Remmina/archive/v1.2.32.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1539806032
mkdir -p clr-build
pushd clr-build
...
cp LICENSE %{buildroot}/usr/share/package-licenses/Remmina/LICENSE
cp LICENSE.OpenSSL %{buildroot}/usr/share/package-licenses/Remmina/LICENSE.OpenSSL
pushd clr-build
%make_install
popd
%find_lang remmina
...
/usr/share/icons/hicolor/scalable/actions/remmina-folder-symbolic.svg
...
/usr/share/package-licenses/Remmina/COPYING
/usr/share/package-licenses/Remmina/LICENSE
/usr/share/package-licenses/Remmina/LICENSE.OpenSSL
