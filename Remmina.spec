...
Version  : 1.4.16
Release  : 27
URL      : https://github.com/FreeRDP/Remmina/archive/v1.4.16/Remmina-1.4.16.tar.gz
Source0  : https://github.com/FreeRDP/Remmina/archive/v1.4.16/Remmina-1.4.16.tar.gz
...
%prep
%setup -q -n Remmina-1.4.16
cd %{_builddir}/Remmina-1.4.16
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1620755111
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/Remmina-1.4.16/COPYING %{buildroot}/usr/share/package-licenses/Remmina/ffe386a510e8e12e7b831dc0c3630f89c5cd4aff
cp %{_builddir}/Remmina-1.4.16/LICENSE %{buildroot}/usr/share/package-licenses/Remmina/62df4d47ea6d73566d5e8de65d8e126fd096fc4f
cp %{_builddir}/Remmina-1.4.16/LICENSE.OpenSSL %{buildroot}/usr/share/package-licenses/Remmina/e3ca00760c7f1c1d8e8b306eb7e41f3bf4d7f10a
pushd clr-build
%make_install
popd
%find_lang remmina
