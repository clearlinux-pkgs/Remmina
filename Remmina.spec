...
Version  : 1.4.40
Release  : 67
URL      : https://github.com/FreeRDP/Remmina/archive/v1.4.40/Remmina-1.4.40.tar.gz
Source0  : https://github.com/FreeRDP/Remmina/archive/v1.4.40/Remmina-1.4.40.tar.gz
...
%prep
%setup -q -n Remmina-1.4.40
cd %{_builddir}/Remmina-1.4.40
pushd ..
cp -a Remmina-1.4.40 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744120507
mkdir -p clr-build
pushd clr-build
